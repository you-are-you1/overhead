/*
	...
	Thanks so much for checking this out and I hope you find it monkey! 
...
public class PlayerMovementWithDash : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (!IsDashing && !IsJumping && !Ascend.isAscending)
        {
            //Ground Check
        ...
        #region DASH CHECKS
        if (CanDash() && LastPressedDashTime > 0 && enableDashAbility)
        {
        ...
        {
            //No gravity when dashing or grapplin or ascending or superdashing
